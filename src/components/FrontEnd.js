    ...
    return(
        <Layout>
            ...
            <Main>
                ...
                <Separator></Separator>
                <h4> 
                 API를 통해 서버와 데이터를 주고 받는 일련의 과정을 이해하고 수행하며, 사용자 인터페이스를 직접 구현합니다.
                </h4>
                <img
                src="../img/front1.png"
                alt="프론트트랙"
                ...
                />
                <h5>
                 배우게 되는 주요 스택 ➡️ HTML/CSS, JAVASCRIPT, REACT
                </h5>
                ...
                <br></br>
                【Study】  테킷 VOD 제공 <br/>
                <small> * 프론트엔드 트랙 뿐만 아니라 백엔드, 디자인, 블록체인 등 다양한 VOD 제공</small><br/>
                <br></br>
